<%-- 
    Document   : comisiones
    Created on : 28/07/2022, 10:43:06 a. m.
    Author     : Randy Trejos
--%>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-link active" aria-current="page" href="comisiones.jsp">Comisiones</a>
        ...
        <div  class="container mt-5 contenedor" style="font-size:14px; " >
            <div class="container mt-2">
                <div class="row">
                    ...
                    <div class="col text-center texto"><h4 class="texto"><%="Comision de hoy : " + inicio%></h4></div>
            ...
            <table class="table table-sm table-striped table-hover texto">
                ...
                <tbody>
                    <%
                        ...
                        ResultSet rs1 = cn1.consultas(" SELECT Empleado,COUNT(Empleado),SUM(Comisión) FROM ventas WHERE Fecha BETWEEN '" + inicio + "'  AND '" + fin + "' AND Sede = '" + sesion.getAttribute("Sede")+ "'GROUP BY Empleado ORDER BY Empleado ;");
                        while (rs1.next()) {
                    %>
                    <tr>
                    ...
                    <tr class="text-center">
                        ...
                        <th style="border-top: 2px solid black;text-align: right;"><strong><%="TOTAL COMISIONES HOY "%></strong></th>
