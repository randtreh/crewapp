<%-- 
    Document   : comision_mes
    Created on : 28/07/2022, 10:54:05 a. m.
    Author     : Randy Trejos
--%>
...
<html>
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-link" aria-current="page" href="consulta_comision.jsp">Consulta comision</a>
                        <a class="nav-link active" aria-current="page" href="comision_mes.jsp">Consolidado por mes</a>
        ...
        <div  class="container mt-5 contenedor" style="font-size:15px; " >
            <form class="form-sign" action="comision_mes.jsp" method="get" > 
                <div class="container">
                    <div class="row">
        ...
        <div  class="container mt-5 contenedor" style="font-size:14px; " >
            <div class="container mt-2">
                <div class="row">
                    ...
                    <div class="col text-center"><h4><%="Comisiones " + mes%></h4></div>
                ...
                <tbody>
                    <%
                        if (request.getParameter("accion") != null) {
                            ...
                            ResultSet rs1 = cn1.consultas(" SELECT Empleado,COUNT(Empleado),SUM(Comisión) FROM ventas WHERE Fecha LIKE '%" + inicio + "%'  AND Sede = '" + sesion.getAttribute("Sede") + "'GROUP BY Empleado ;");
                            while (rs1.next()) {
                    %>
                    <tr>
