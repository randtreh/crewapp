...
public class Controlador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (accion){
                ...
                case "inicio1":
                request.getRequestDispatcher("inicio1.jsp").forward(request, response);
                case "inicio3":
                request.getRequestDispatcher("inicio3.jsp").forward(request, response);
                case "Historial":
                ...
                case "adicion":
                request.getRequestDispatcher("adicionales.jsp").forward(request, response);
                case "factura":
