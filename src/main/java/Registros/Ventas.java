    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("Borrar") != null) {
            ...
            if (resp == 0) {
                ...
                borrar.ejecutarSentenciasSql(" DELETE FROM `ventas` WHERE `IdVentas`='" + id + "';");
                response.sendRedirect("../Proyecto/Modulo_registros/Ventas.jsp?respuesta=si");
            } else {
                response.sendRedirect("../Proyecto/Modulo_registros/Ventas.jsp");
            }
