<%-- 
    Document   : ventas
    Created on : 10/03/2022, 4:34:32 p. m.
    Author     : Randy Trejos
--%>
    ...
    <body>
       ...
       <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-link active" aria-current="page" href="ventas_consulta.jsp">Consulta por fecha</a>
        ...
        <div  class="container mt-5 contenedor" style="font-size:15px; " >
            <form class="form-sign" action="ventas_consulta.jsp" method="get" > 
                <div class="container">
                    <div class="row">
                ...
                <tbody>
                    <%
                        if (request.getParameter("accion") != null) {
                            ResultSet rs1 = cn1.consultas(" SELECT * FROM ventas WHERE Fecha LIKE '%" + inicio + "%'   AND Sede = '" + sesion.getAttribute("Sede")+ "' ORDER BY Fecha ;");
                            while (rs1.next()) {
                    %>
                    ...
                    <tr class="text-center">
                        ...
                        <th style="border-top: 2px solid black;text-align: right;"><strong><%="TOTAL DIA " + inicio%></strong></th>
