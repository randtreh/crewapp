<%-- 
    Document   : ventas_mes
    Created on : 26/07/2022, 12:23:19 p. m.
    Author     : Randy Trejos
...
<html>
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-link active" aria-current="page" href="ventas_mes.jsp">Consulta Mes</a>
        ...
        <div  class="container mt-5 contenedor" style="font-size:15px; " >
            <form class="form-sign" action="ventas_mes.jsp" method="get" > 
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col ">Filtro por mes : <input type="month" name="inicio" required="" ></div>
        ...
        <div  class="container mt-5 contenedor" style="font-size:14px; " >
            <div class="container mt-2">
                <div class="row">
                    ...
                    <div class="col text-center"><h4><%="Ventas " + mes%></h4></div>
                ...
                <tbody>
                    <%
                        if (request.getParameter("accion") != null) {
                            ...
                            ResultSet rs1 = cn1.consultas(" SELECT Fecha, COUNT(Fecha), SUM(Valor),SUM(Comisión) FROM ventas WHERE Fecha like '%" + inicio + "%' AND Sede = '" + sesion.getAttribute("Sede")+ "' GROUP BY Fecha ORDER BY Fecha;");
                            while (rs1.next()) {
                    %>
                    <tr>
                    ...
                    <tr class="text-center">
                        ...
                        <th style="border-top: 2px solid black;"></th>
                            <%                                ResultSet rs2 = cn1.consultas(" SELECT Fecha, COUNT(Fecha), SUM(Valor),SUM(Comisión) FROM ventas WHERE Fecha like '%" + inicio + "%' AND Sede = '" + sesion.getAttribute("Sede")+ "';");
                                while (rs2.next()) {
                            %>
                        </th>
                        <th style="border-top: 2px solid black;text-align: right;"><strong><%="TOTAL MES " + mes%></strong></th>
