<%-- 
    Document   : Servicios
    Created on : 1/02/2022, 3:01:20 p. m.
    Author     : Randy Trejos
--%>
...
<html lang="en">
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="cell container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            <li class="nav-item"><a id="seleccion" href="Servicios.jsp">SERVICIOS</a></li><br>
        ...
        <section>
            ...
            <div  class="container mt-2 contenedor" style="font-size:14px; " >
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <%
                            ...
                            ResultSet rs = cn.consultas(" SELECT * FROM `servicios` where Tipo='AUTOMOVIL';");
                            while (rs.next()) {
                        %>
                        <tr>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <%
                            ...
                            ResultSet rs1 = cn1.consultas(" SELECT * FROM `servicios` where Tipo='CAMIONETA';");
                            while (rs1.next()) {
                        %>
                        <tr>
