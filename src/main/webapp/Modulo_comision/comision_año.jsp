<%-- 
    Document   : comision_año
    Created on : 28/07/2022, 10:54:16 a. m.
    Author     : Randy Trejos
--%>
...
<html>
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-link active" aria-current="page" href="comision_año.jsp">Consolidado por año</a>
        ...
        <div  class="container mt-5 contenedor" style="font-size:15px; " >
            <form class="form-sign" action="comision_año.jsp" method="get" > 
                <div class="container">
                    <div class="row">
                        ...
                        </div>                        <div class="col order-first"></div>
                    </div>
                </div>
            </form>
        </div>
        <div  class="container mt-5 contenedor" style="font-size:14px; " >
            <div class="container mt-1">
                <div class="row">
                    ...
                    <div class="col text-center"><h4><%="Comisiones " + inicio%></h4></div>
            ...
            <table class="table table-sm table-striped table-hover texto mt-4">
                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <th style="border-top: 2px solid black;text-align: right;"><strong><%="TOTAL COMISIONES AÑO " + inicio%></strong></th>
